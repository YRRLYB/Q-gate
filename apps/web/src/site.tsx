...
const defaultSiteSettings: SiteSettings = {
  ...
  home: {
    ...
    title: "Q-gate 准入入口",
    subtitle:
      "先确认身份，再完成基础问答；通过后拿到短验证码，直接填写到进群申请问题里。",
  ...
  entry: {
    ...
    bindingExplain:
      "答题通过后的验证码会和 QQ、Minecraft 用户名一起绑定，用于进群申请校验。",
    ...
    boundContact: "如果绑定信息有误，请联系审核管理员处理。",
    confirmAvatar:
      "我已确认当前 QQ 头像和号码，就是这次准备用于进群申请的账户。",
    confirmPrivacy:
      "我已知晓本页填写的 QQ 与游戏名会用于绑定本次答题结果，并用于后续验证码归属校验。",
  },
  session: {
    eyebrow: "SESSION / EXAM",
    subtitle:
      "剩余时间会实时刷新，右侧可以快速跳题；如果题库要求全屏，Q-gate 会在进入前直接整屏拦截。",
    ...
    navTitle: "题号导航",
    submitHint:
      "提交后会显示总分、错题和你的作答记录；参考答案不会在结果页公开显示。",
    submitButton: "提交并判分",
    fullscreenTitle: "当前题库要求全屏作答",
    fullscreenBody:
      "未进入全屏前无法开始答题；中途切出页面或退出全屏时，系统会直接整屏警告并记录次数。",
  ...
  result: {
    ...
    failTitle: "本次未通过",
    passSubtitle:
      "接下来把验证码填写到进群申请问题里，或者交给群内 bot 校验。错题解析可以按需展开查看。",
    failSubtitle:
      "这次先把错题和你的作答记录过一遍，冷却结束后再重新开一轮会更稳。",
    copyButton: "复制验证码",
    copiedButton: "已复制",
    homeButton: "返回首页",
    retryButton: "返回重新答题",
    ...
    noWrongTitle: "本次没有错题",
    noWrongBody:
      "这次答题没有出现错误项，接下来只需要把验证码填写到进群申请问题即可。",
  },
  admin: {
    ...
    loginTitle: "管理员登录",
    loginSubtitle:
      "使用管理员密码登录。浏览器可以记住密码，但每次重新进入管理端时仍需要再次验证。",
    loginButton: "进入工作台",
    logoutButton: "退出登录",
    siteSettingsTitle: "站点文案",
    siteSettingsNote:
      "想改名字、首页标题、按钮文案或品牌图，只需要维护这一份 YAML。",
  },
};
